...
function Header() {
  ...
  return (
    <div className="header">
      ...
      >
        <h3 className="header__bar__title">Anurag Kumar</h3>
        <div className="header__bar__icons">
          <a href="https://github.com/Anurag236" target="_blank">
            <img src="https://img.icons8.com/ios/50/000000/github--v1.png" />
          </a>
          <a href="https://www.linkedin.com/in/anurag-kumar-a64242223/" target="_blank">
